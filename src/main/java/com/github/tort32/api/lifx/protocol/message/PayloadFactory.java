...
import com.github.tort32.api.lifx.protocol.device.recieve.EchoResponse;
import com.github.tort32.api.lifx.protocol.device.recieve.StateHostFirmware;
import com.github.tort32.api.lifx.protocol.device.recieve.StateHostInfo;
import com.github.tort32.api.lifx.protocol.device.recieve.StateInfo;
import com.github.tort32.api.lifx.protocol.device.recieve.StateLabel;
import com.github.tort32.api.lifx.protocol.device.recieve.StateService;
import com.github.tort32.api.lifx.protocol.device.recieve.StateVersion;
import com.github.tort32.api.lifx.protocol.device.recieve.StateWifiFirmware;
import com.github.tort32.api.lifx.protocol.device.recieve.StateWifiInfo;
...
public class PayloadFactory {
	...
	static {
    	...
    	register(GetService.class, StateService.class, StateHostInfo.class, StateHostFirmware.class,
    			StateWifiInfo.class, StateWifiFirmware.class, com.github.tort32.api.lifx.protocol.device.recieve.StatePower.class,
    			StateLabel.class, StateVersion.class, StateInfo.class, Acknowledgement.class, EchoResponse.class); // Device responses
    	register(State.class, com.github.tort32.api.lifx.protocol.light.recieve.StatePower.class); // Light responses
    }
}
