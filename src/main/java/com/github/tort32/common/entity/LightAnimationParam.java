...
import com.github.tort32.common.animation.IAnimation.CheckerParam;
import com.github.tort32.common.animation.IAnimation.RangeParam;
import com.github.tort32.common.animation.IAnimation.SelectorParam;
import com.wordnik.swagger.annotations.ApiModel;
import com.wordnik.swagger.annotations.ApiModelProperty;

@ApiModel(value = "Light animation parameter")
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class LightAnimationParam {
	...
	LightAnimationParam(AnimationParam<?> param) {
